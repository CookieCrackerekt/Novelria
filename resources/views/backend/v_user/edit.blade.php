...
@section('content')
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <form action="{{ route('backend.user.update', $edit->user_id) }}" method="POST"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="role" class="form-control @error('role') is-invalid @enderror">
                                            <option value="" {{ old('role', $edit->role) == '' ? 'selected' : '' }}>- Pilih
                                                Hak Akses -</option>
                                            <option value="0" {{ old('role', $edit->role) == '0' ? 'selected' : '' }}>Super
                                                Admin</option>
                                            <option value="1" {{ old('role', $edit->role) == '1' ? 'selected' : '' }}>Admin
                                            <option value="2" {{ old('role', $edit->role) == '2' ? 'selected' : '' }}> User
                                            </option>
                                        </select>
                                        @error('role')
