...
<head>
    ...
    <title>Admin Dashboard Novelria</title> <!-- Custom CSS -->
                    ...
                    <ul id="sidebarnav" class="p-t-30">
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark"
                                href="javascript:void(0)" aria-expanded="false"><i class="mdi mdi-shopping"></i><span
                                    class="hide-menu">Data Novel </span></a>
                            <ul aria-expanded="false" class="collapse first-level">
                                <li class="sidebar-item"><a href="{{ route('backend.genre.index') }}"
                                        class="sidebar-link"><i class="mdi mdi-chevron-right"></i><span
                                            class="hide-menu"> Genre </span></a> </li>
                                <li class="sidebar-item"><a href="{{ route('backend.novel.index') }}"
                                        class="sidebar-link"><i class="mdi mdi-chevron-right"></i><span
                                            class="hide-menu"> Novel </span></a> </li>
                            </ul>
                        </li>
                        <li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark"
                            ...
                            <ul aria-expanded="false" class="collapse first-level">
                                ...
                                <li class="sidebar-item"><a href="{{ route('backend.laporan.formnovel') }}"
                                        class="sidebar-link"><i class="mdi mdi-chevron-right"></i><span 
                                            class="hide-menu"> Novel </span></a></li>
                            </ul>
                        </li>
