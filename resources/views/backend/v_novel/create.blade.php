                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <p></p>
                                    <input type="file" name="image" class="form-control @error('image') is-invalid @enderror" onchange="previewFoto()" accept=".jpg,.jpeg,.png,.webp" required>
                                    @error('image')
                            ...
                            <div class="col-md-8">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="title" value="{{ old('title') }}" 
                                        class="form-control @error('title') is-invalid @enderror" placeholder="Masukkan Judul Novel" required>
                                    @error('title')
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="file" name="pdf" class="form-control @error('pdf') is-invalid @enderror" accept=".pdf" required>
                                    @error('pdf')
                                        <span class="invalid-feedback alert-danger" role="alert">{{ $message }}</span>
                                    @enderror
                                </div>
